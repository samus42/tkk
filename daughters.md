...
There is a special skill you need to succeed from here on out.  Pay attention now, because it's very technical.  *You must know which direction counter-clockwise is*.  Make sure to ask the rest of the fireteam, make them prove it to you by running around the map in a counter-clockwise fashion.  If they can't do it, yawn, say it's late, get the hell off that fireteam and find one that understands basic directionality.
...
Now the way this works, is that as soon as you step onto one of those platforms, a 1 minute timer will start.  At the end of that 1 minute, the sisters will kill you with a big shriek.  Apparently they need to warm up their vocal chords or something like that.  Your only hope of living is to be in some sort of shield.  It looks like the only shields available are in use right now, so we're going to have to steal one of them.
...
However, since Oryx is a dick, you **must** jump up on the corner platforms in a particular order.  However the order is pretty easy to figure out.  Start with the platform counter-clockwise to the platform with the orb above it.  Once the platforms are all lit up, you can jump up the ghostly platforms in a counter-clockwise fashion until you reach the glowy pineapple in the sky.
...
Now this shield is different than the Titan shields you're used too.  First off, nothing can hurt something inside the shield.  That's right, you're invincible!  Even better, unlike the Titan shield, you can shoot out of it!  Which means you can kill the sister whom you stole the shield from.  Feel free to do your evil mastermind laugh.
...
The next people in counter-clockwise order should jump up on their platforms, also vocalizing so things happen in proper order.  The 4th person **should not** go on their platform.  Instead help out with adds, but stick close to your platform for reasons I will be getting too.
...
Basically keep your feet on that platform until you hear the runner tell you they have the pineapple.  If you're getting hit, duck down and move to the back of the platform.
...
Once her life is low, use the remaining time in your bubble to wipe out any Taken bad guys still around.  You shield will actually last a bit past the timer, you can safely move out once the light fades.
...
**A:** When you have a relatively low light level team, this can happen.  What you might want to try is to assign a Warlock with self-res to clear adds while everyone hammers the sister.  Just make sure they get back into the bubble in time.
