...
For pretty much the whole guide I've been pretty much been laying it out as if you were playing hard mode, since the differences weren't that great.  However I'm going to change it up here.  While most of the base mechanics are the same in normal vs hard, there is one small difference that changes the whole game.  
...
So this part will be doing Oryx normal style.  Once you get this down you can move onto hard mode.  I do want to point out, that even though you may have made it this far, you might not have the light level to beat Oryx.  If so, don't sweat it.  Try again next week and hopefully the drops from the bosses will get you up high enough.
...
Unfortunately it's really Oryx, who does not want to be your friend.  
At the start, Taken will spawn on the front left & right corners.  These guys are not a problem, you can easily wipe them out.  Frankly, they are there to provide you with ammo.
...
**Q: Dude, he's staggered, but it looks like we've done no damage!  What give?**
...
**A:** Don't worry, it's normal mode, so you can get resurrected.  However I recommend staying dead unti after...
...
Near the front of the map, Oryx will create a big black dome.  Stay away, it will kill you if you touch it.  Your first priority will be the Knights the spawn on the front 2 platforms.  After that, Thrall will spawn in the front corners following the pattern: Right, Left, Left, Right, Right, etc, etc.
...
**A:** You are facing the Shade of Oryx.  It will hang around outside the edge of the bubble.  However, you *can* shoot it.  
Periodically it will warp left 90 degrees, right 90 degrees, or 180 degrees.  Don't worry, you'll get help along the way as your team mates get warped in one by one.  Keep tracking it and try to hit it in the head.  Machine guns are good here. Eventually it will charge in, at which point you need to avoid it's big sword which will kill you with one swing.  After it's swing, it will take off again.
...
**A:** This will be covered in a later guide *Battleborn Guide to Dating the Darkness*.  It will give you step by step instructions on bring romance to a Taken's existence.
